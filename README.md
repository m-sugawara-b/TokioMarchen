...
<br>
<a href="#concept">&nbsp;&nbsp;&nbsp;2.2.コンセプト</a>
<br>
<a href="#target">&nbsp;&nbsp;&nbsp;2.3.ビジョンステートメント</a>
<br>
<a href="#target">&nbsp;&nbsp;&nbsp;2.4.ターゲット</a>
<br>
<a href="#Story">&nbsp;&nbsp;&nbsp;2.5.ストーリー</a>
<br>
...
<a name="concept"></a>
### 2.2.コンセプト
-	青年の不安とその葛藤が引き起こす悲劇<br>
	若者の、言葉にはならない、漠然とした社会や将来や世界への不安感を表現する。

<a name="vision"></a>
### 2.3.ビジョンステートメント
-	青年の不安と葛藤からくる不器用さをプレイヤーが追体験するホラーアクションゲーム。
